...
void loop() {  //phase 1:MOTOR.setSpeedDir(30,DIRF); // moves the robot forward
  //phase 1:MOTOR.setSpeedDir(30,DIRF); // moves the robot forward
  
  delay(1500);MOTOR.setStop1();           // stops the right motor wheels
